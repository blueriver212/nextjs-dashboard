    ...
    console.log(`Created "simulation" table`);
      ...
      const insertedSimulations = await Promise.all(
        simulations.map(
          ...
          INSERT INTO simulations (simulation_name, owner, description, created, modified, scenario_properties, species)
          VALUES (${simulation.simulation_name}, ${simulation.owner}, ${simulation.description}, ${simulation.created}, ${simulation.modified}, ${simulation.scenario_properties}, ${simulation.species});        `,
        ),
      );
